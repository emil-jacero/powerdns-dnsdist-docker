...
This is simple PowerDNS dnsdist loadbalancer built to accompany [powerdns-auth-docker](https://github.com/emil-jacero/powerdns-auth-docker) & [powerdns-recursor-docker](https://github.com/emil-jacero/powerdns-recursor-docker)
